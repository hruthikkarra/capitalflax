...
export const metadata: Metadata = {
  ...
  description:
    'Learn about CapitalFlax — India\'s premium financial services company built for professionals. Our mission, values, leadership team, and the story behind 10,000+ happy professionals.',
  keywords: [
    'about capitalflax',
  ...
  openGraph: {
    ...
    description:
      'CapitalFlax is India\'s premium financial services company built for doctors, CAs, architects and professionals. Learn our story, mission and team.',
